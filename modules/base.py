...
class LiveModule(ABC):
    ...
    def __repr__(self):
        return f"<{self.__class__.__name__} (live) name={self.name} version={self.version}>"
...
def read_summary(filepath: str) -> Optional[Summary]:
    ...
    try:
        ...
        return Summary(
            ...
            top_protocols=data.get('top_protocols', {}),
        ...
        with open(filepath, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                try:
                    ...
                    known = {
                        'stt', 'ts_sec', 'label', 'src', 'dst',
                        'sport', 'dport', 'proto',
                        'priority', 'category', 'alert_id',
                    }
                    det = Detection(
                        stt=data.get('stt', 0),
                        ...
                        category=data.get('category', Category.ANOMALY.value),
