...
WELL_KNOWN_PORTS = {
    ...
    # DoH (DNS over HTTPS)
    # Uses standard HTTPS port; detected by content
    # DoQ (DNS over QUIC)
    853: "DoT/DoQ",               # RFC 9250
    # mDNS
    5353: "mDNS",
    # LLMNR
    5355: "LLMNR",
...
DEFAULT_BPF_VALIDATE_TIMEOUT = 5.0  # Seconds to wait for BPF validation
MAX_DISPLAY_FILTER_LEN = 1024   # Max display filter string length
DEFAULT_PACKET_SLICE_BYTES = 256  # Packet slicing for memory efficiency
...
DEFAULT_FSYNC_BATCH_INTERVAL = 1.0  # Seconds between fsync calls
DEFAULT_HIGH_PRESSURE_THRESHOLD = 0.8  # Ring buffer high-water mark
