...
from config import OUTPUT_CSV, DEFAULT_PCAP_DIR, DEFAULT_OUTPUT_DIR
...
def extract_features(
    ...
    # ------------------------------------------------------------------
    logger.info("-" * 70)
    logger.info("BUOC 1/4: Trich xuat bang Argus")
    logger.info("-" * 70)
    ...
    # ------------------------------------------------------------------
    logger.info("-" * 70)
    logger.info("BUOC 2/4: Trich xuat bang Zeek")
    logger.info("-" * 70)
    ...
    # ------------------------------------------------------------------
    logger.info("-" * 70)
    logger.info("BUOC 3/4: Chuan hoa du lieu (Data Mapping)")
    logger.info("-" * 70)
    ...
    # ------------------------------------------------------------------
    logger.info("-" * 70)
    logger.info("BUOC 4/4: Merge & Xuat CSV")
    logger.info("-" * 70)
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            f"\nDuong dan mac dinh:\n"
            f"  PCAP input dir : {DEFAULT_PCAP_DIR}\n"
