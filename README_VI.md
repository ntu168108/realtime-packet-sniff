...
- Bảy classifier per-family (mô hình binary one-vs-rest): `dos`, `exploits`, `fuzzers`, `generic`, `analysis`, `reconnaissance`, `shellcode`.
...
**Các attack family** (taxonomy UNSW-NB15, mỗi family một binary classifier):
